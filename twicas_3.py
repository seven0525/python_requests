...
def get_request():
    ...
    if listOfNumbers[0] + listOfNumbers[1] + listOfNumbers[2]+ listOfNumbers[3] + listOfNumbers[4] + listOfNumbers[5] + listOfNumbers[6]  == listOfNumbers[-1]:
        answer = "++++++"
        answer_def(id_number, answer)
    elif listOfNumbers[0] + listOfNumbers[1] + listOfNumbers[2]+ listOfNumbers[3] + listOfNumbers[4] + listOfNumbers[5] - listOfNumbers[6]  == listOfNumbers[-1]:
        answer = "+++++-"
        answer_def(id_number, answer)
    elif listOfNumbers[0] + listOfNumbers[1] + listOfNumbers[2]+ listOfNumbers[3] + listOfNumbers[4] - listOfNumbers[5] - listOfNumbers[6]  == listOfNumbers[-1]:
        answer = "++++--"
        ...
        delete_request()
        get_request() #もう一度GETを行う
        
def answer_def(id_number, answer):
